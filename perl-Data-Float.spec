...
%package man
Summary: man components for the perl-Data-Float package.
Group: Default

%description man
man components for the perl-Data-Float package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Data/Float.pm
